                ...
                <div class="modal-body">
                    <form action="{{ route('staffs.update', $staff->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" value="{{ $staff->student->user->name }}"
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" value="{{ $staff->student->user->address }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" value="{{ $staff->student->user->contact }}""
                            ...
                            <div class="col">
                                <div class="form-floating mb-3">
                                    <input type="date" class="form-control" id="dob" name="dob"
                                        placeholder="Date of Birth" value="{{ $staff->student->user->dob }}" required />
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" id="floatingSelect" aria-label="Floating label select example"
                                ...
                                <option value="1" @if ($staff->student->user->gender == 'male') selected @endif>Male</option>
                                <option value="2" @if ($staff->student->user->gender == 'female') selected @endif>Female</option>
                                <option value="3" @if ($staff->student->user->gender == 'others') selected @endif>Others</option>
                            </select>

...
@section('add-btn')
    ...
    @endif
    <a href="{{ route('school_admin.guardians.index') }}" class="btn btn-primary">Back</a>
@endsection
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex flex-column align-items-center text-center">
                                            ...
                                            <div class="mt-3">
                                                <h4> {{ $guardian->name }} | {{ $guardian->gender }}
                                                </h4>
                                                ...
                                                <div class="d-flex gap-2 justify-content-center">
                                                    <a href="{{ route('school_admin.staffs.edit', $guardian->id) }}"
                                                        class="btn btn-success">Edit</a>
                                                    <form action="{{ route('school_admin.staffs.destroy', $guardian->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('delete')
                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        <div class="card-heading text-center mb-4">
                                            <h3 class="">Guardian's Information:</h3>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary"> {{ $guardian->email }}
                                            </div>
                                        </div>
                                        <hr />
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-9 text-secondary">
                                                <ol>
                                                    @if (isset($guardian->guardian->students[0]))
                                                        @foreach ($guardian->guardian->students as $child)
                                                            <a
                                                                href="{{ route('school_admin.students.show', $child->id) }}">
                                                                {{ $child->user->name }} </a> <br>
                                                        @endforeach
                                                    @else
                                                        To link guardian with student:
                                                        <li> Goto Manage Users->Manage Students, on left sidebar </li>
                                                        <li> Search for student, click on details button </li>
                                                        <li> Click on Edit button </li>
                                                        <li> Look for Guardian Information section </li>
                                                        <li> Select guardian, you can select multiple guardians,
                                                            <br>keyboard-shortcut: <strong>Ctrl + mouse click</strong>
                                                        </li>
